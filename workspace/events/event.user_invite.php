<?php
	...
	Class eventuser_invite extends Event{

		const ROOTELEMENT = 'user-invite';
		...
		public static function about(){
			return array(
				...
				'release-date' => '2012-06-01T04:08:51+00:00',
				'trigger-condition' => 'action[user-invite]'
			);
		}
        ...
        <pre class="XML"><code>&lt;user-invite result="success" type="create | edit">
  &lt;message>Entry [created | edited] successfully.&lt;/message>
&lt;/user-invite></code></pre>
        <p>When an error occurs during saving, due to either missing or invalid fields, the following XML will be returned:</p>
        <pre class="XML"><code>&lt;user-invite result="error">
...
&lt;/user-invite></code></pre>
  ...
  &lt;/label>
  &lt;input name="action[user-invite]" type="submit" value="Submit" />
&lt;/form></code></pre>
		...
		public function load(){
			if(isset($_POST['action']['user-invite'])) return $this->__trigger();
		}
