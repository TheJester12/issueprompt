<?php
	...
	Class eventproject_new extends Event{

		const ROOTELEMENT = 'project-new';
		...
		public static function about(){
			return array(
				...
				'release-date' => '2012-05-10T05:32:12+00:00',
				'trigger-condition' => 'action[project-new]'
			);
		}
        ...
        <pre class="XML"><code>&lt;project-new result="success" type="create | edit">
  &lt;message>Entry [created | edited] successfully.&lt;/message>
&lt;/project-new></code></pre>
        <p>When an error occurs during saving, due to either missing or invalid fields, the following XML will be returned:</p>
        <pre class="XML"><code>&lt;project-new result="error">
...
&lt;/project-new></code></pre>
  ...
  &lt;input name="action[project-new]" type="submit" value="Submit" />
&lt;/form></code></pre>
		...
		public function load(){
			if(isset($_POST['action']['project-new'])) return $this->__trigger();
		}
