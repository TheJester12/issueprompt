<?php
	...
	Class eventissue_edit extends Event{

		const ROOTELEMENT = 'issue-edit';
		...
		public static function about(){
			return array(
				...
				'release-date' => '2012-05-10T03:51:13+00:00',
				'trigger-condition' => 'action[issue-edit]'
			);
		}
        ...
        <pre class="XML"><code>&lt;issue-edit result="success" type="create | edit">
  &lt;message>Entry [created | edited] successfully.&lt;/message>
&lt;/issue-edit></code></pre>
        <p>When an error occurs during saving, due to either missing or invalid fields, the following XML will be returned:</p>
        <pre class="XML"><code>&lt;issue-edit result="error">
...
&lt;/issue-edit></code></pre>
  ...
  &lt;input name="action[issue-edit]" type="submit" value="Submit" />
&lt;/form></code></pre>
		...
		public function load(){
			if(isset($_POST['action']['issue-edit'])) return $this->__trigger();
		}
